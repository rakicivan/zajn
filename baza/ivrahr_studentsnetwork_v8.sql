...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 18, 2016 at 02:56 PM
...
(6, 'test', 7, 0, 1, '2016-03-17 17:19:39'),
(7, 'Neki komentar', 7, 0, 1, '2016-03-17 17:21:51'),
(8, 'tetete', 7, 0, 29, '2016-03-17 17:33:35'),
(9, 'komentar', 7, 0, 29, '2016-03-18 00:06:54');
...
(1, 1, '2016-02-18 00:00:00', 0, 0, NULL),
(2, 5, '2016-02-09 00:00:00', 0, 1, NULL),
(7, 1, '2016-03-12 21:23:51', 0, 0, NULL),
(7, 6, '2016-03-18 00:16:05', 0, 1, NULL);
...
INSERT INTO `notifications` (`notification_ID`, `owner`, `sender`, `text`, `link_target`, `received_at`, `sent_at`, `seen`, `notification_type`) VALUES
(1, 6, 7, 'Testni', NULL, NULL, NULL, 0, 0),
(2, 7, 6, 'Testni', NULL, NULL, NULL, 0, 1),
(3, 5, 7, 'Testni', NULL, NULL, NULL, 0, 0),
(4, 2, 6, 'tetetete', NULL, NULL, NULL, 0, 0),
(5, 1, 1, NULL, 1, NULL, '2016-03-18 14:53:36', 0, 0);
...
(1, 'test@foi.com', '123', 2, 3, 3, 3, 0, 0, 3, NULL, NULL, NULL, NULL, NULL, 0, 2, NULL, NULL, NULL, 1, 'name_proba', 'surname_proba', 3, NULL, 0, '2016-03-16 21:24:32'),
...
(5, 'dsokac@foi.hr', 'danisoka992', 2, 3, 3, 3, 0, 0, 3, '0981658704', '6019832100160922635', 'M', '2016-02-18 12:07:48', '1992-10-20 00:00:00', 0, NULL, 'page_imgs/default.jpg', 'Soky', '3', 1, 'Danijel', 'Sokač_test', 3, 1, 0, '2016-03-13 09:39:46'),
(6, 'admin@irva.hr', 'karatehr', 2, 3, 3, 3, 0, 0, 3, '08765432', '6019832100160922639', 'M', '2016-03-03 18:26:58', '1988-03-17 00:00:00', 0, NULL, 'page_imgs/default.jpg', 'Sokač', '2', 1, 'Danijel', 'Sokač', 3, 1, 0, '2016-03-05 14:47:49'),
(7, 'testni@foi.hr', 'nekipass92', 3, 3, 4, 2, 0, 0, 3, NULL, NULL, NULL, NULL, NULL, 0, NULL, 'page_imgs/default.jpg', NULL, NULL, 1, 'Ivo', 'Ivić', NULL, NULL, 0, '2016-03-18 14:02:57');
...
--
ALTER TABLE `comments`
  MODIFY `comment_ID` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=29;
--
...
--
ALTER TABLE `posts`
  MODIFY `post_ID` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=45;
--

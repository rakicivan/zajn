<?php
    $template = $twig->loadTemplate("scripts/admin/admin_landing.twig");
    ...
    <script type="text/javascript">
        ...
        $("#filter_subjects select").on('change', '', function (e) {
            ...
            function successFunction(data){
                ...
                $("#scriptUpload label").html(data.courses[0].name);
                $("#scriptUpload").show();
            }
            function errorFunction(error){
                console.log(error.responseText);
        ...
        $('#filter_years select').on('change', '', function (e) {
            ...
            function successFunction(data){
                ...
                $("#scriptUpload label").html(data[0].name);
            }
            function errorFunction(error){
                console.log(error.responseText);
            }
